...
def update_firebase():
    ...
    if not is_network_available():
        ...
        print(f"Accumulated data - Entered: {session_enter_count}, Offenders: {session_offender_count}")
        session_reset()
        return
    ...
    try:
        ...
        # Update local current data with the new values
        ...
        session_reset()
        fetch_firebase_data()  # Fetch the updated data immediately after updating Firebase
